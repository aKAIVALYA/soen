...
const ProjectPage = () => {
  ...
  useEffect(() => {
    // Only run if location.state.project exists and has _id
  ...
  return (
    <main className="h-screen w-screen flex">
      <section className="left relative flex flex-col h-screen min-w-96 bg-slate-300">
        <header className="flex justify-between items-center p-2 px-4 w-full bg-slate-100 relative z-20">
        ...
        <div className="conversation-area pt-14 pb-10 flex-grow flex flex-col h-full relative">
          ...
          <div className="inputField w-full flex absolute bottom-0">
            <input
              ...
              className="p-2 px-4 border-none outline-none flex-grow bg-slate-100 "
              type="text"
              placeholder="Enter message"
            />
            <button onClick={send} className=" px-5 bg-slate-800 text-white">
